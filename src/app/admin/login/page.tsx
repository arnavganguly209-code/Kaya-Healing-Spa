    ...
    <main className="relative min-h-[100svh] overflow-hidden bg-[#fffdf9] text-[#171717]">
      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-6xl items-center justify-center px-5 py-12 lg:justify-between lg:px-10">
        <div className="hidden max-w-md lg:block">
          ...
          <h1 className="mt-4 font-serif text-6xl leading-[0.95] text-[#171717]">Your content desk.</h1>
          <p className="mt-5 text-[15px] leading-7 text-[#6B6B6B]">
            Hero, footer, services, packages, therapists, blog posts, and booking requests — without full Orbit access.
          </p>
        </div>
        <form onSubmit={onSubmit} className="w-full max-w-[440px] rounded-[28px] border border-[#efe8e0] bg-white px-8 py-10 shadow-[0_24px_70px_rgba(23,23,23,0.08)]">
          <Logo size={84} />
          <p className="mt-6 text-[11px] font-medium tracking-[0.28em] text-[#F47B20] uppercase">Admin</p>
          <h2 className="mt-2 font-serif text-4xl text-[#171717]">Sign in</h2>
          <p className="mt-3 text-sm leading-6 text-[#6B6B6B]">Manage day-to-day content for {site.name}.</p>
          <label className="mt-8 block text-[11px] font-medium tracking-[0.18em] text-[#8a8a8a] uppercase">
            ...
            <input
              ...
              required
              className="mt-2 w-full rounded-2xl border border-[#efe8e0] bg-[#fffdfb] px-4 py-3.5 text-base text-[#171717] outline-none focus:border-[#F47B20]"
            />
          </label>
          <label className="mt-4 block text-[11px] font-medium tracking-[0.18em] text-[#8a8a8a] uppercase">
            Password
            <input
              type="password"
              value={password}
