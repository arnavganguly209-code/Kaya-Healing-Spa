          ...
          {section === "Gallery" && (
            <>
              <GalleryCategoryBank
                ...
                setGallery={(gallery) => setContent({ ...content, gallery })}
                publishGallery={(gallery) => publish({ ...contentRef.current, gallery })}
                upload={upload}
                onPickLibrary={(apply) => setPicker((src: string) => apply(src))}
              />
            </>
          )}
          {section === "Page covers" && (
