    ...
    case "tiktok":
      return (
        <svg className={iconClass} viewBox="0 0 24 24" aria-hidden>
          ...
          <path
            fill="#25F4EE"
            d="M16.6 8.1v2.2a4.9 4.9 0 0 0-2.8-.9v5.8a3.6 3.6 0 1 1-3.6-3.6c.3 0 .6 0 .9.1v2.4a1.4 1.4 0 1 0 1 1.3V6.5h2.5c.2 1 .9 1.8 1.9 2.1z"
          />
          <path
            fill="#FE2C55"
            d="M16.6 6.5v1.6c-.9-.3-1.7-1.1-1.9-2.1h-1.9v8.9a1.4 1.4 0 1 1-1-1.3V13c-.3-.1-.6-.1-.9-.1a3.6 3.6 0 1 0 3.6 3.6V9.4c1 .6 2.2.9 3.4.9V8.1c-.6 0-1.2-.1-1.7-.3z"
            opacity=".9"
          />
        </svg>
      );
